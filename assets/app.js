...
function bootstrapCommonMakesIfEmpty() {
  ...
  const common = [
    "Chevrolet","GMC","CDJR","Ram","Toyota","Honda","Nissan","Hyundai","Kia",
    "Jeep","Volkswagen","Subaru","CDJR","BMW","Mercedes-Benz","Audi","Dodge",
...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk CDJR Dorchester Braintree"],
    ["successTitle", "¡Gracias! - Quirk CDJR Dorchester Braintree"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk CDJR Dorchester Braintree se pondrá en contacto con usted en breve."]
  ]);
